      ...
      function updateMaxLengthHTML(currentInputText, maxLengthThisInput, typedChars) {
        ...
        if (options.message) {
          if (typeof options.message === 'function') {
            ...
            output = options.message.replace('%charsTyped%', numberWithCommas(typedChars))
              .replace('%charsRemaining%', numberWithCommas(maxLengthThisInput - typedChars))
              .replace('%charsTotal%', numberWithCommas(maxLengthThisInput));
          }
        } else {
          if (options.preText) {
          ...
          if (!options.showCharsTyped) {
            output += numberWithCommas(maxLengthThisInput - typedChars);
          }
          else {
            output += numberWithCommas(typedChars);
          }
          if (options.showMaxLength) {
            output += options.separator + numberWithCommas(maxLengthThisInput);
          }
          if (options.postText) {
